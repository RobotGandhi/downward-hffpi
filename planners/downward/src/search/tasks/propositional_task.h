...
private:
    ...
    dlplan::policy::PolicyBuilder m_policy_builder;
...
public:
     ...
     * Getters.
     */
    dlplan::policy::PolicyBuilder& get_policy_builder();
    dlplan::core::SyntacticElementFactory& get_syntactic_element_factory();
