...
if project.REMOTE:
    SUITE = ["barman", "blocksworld", "childsnack", "clear", "delivery", "depots", "driverlog", "ferry", "freecell", "gripper", "miconic-with-fix", "nomystery", "n-puzzle", "on", "parking", "pipesworld-notankage", "pipesworld-tankage", "reward", "satellite", "sokoban", "spanner", "visitall", "zenotravel"]
